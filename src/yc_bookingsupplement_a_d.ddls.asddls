...
define view entity YC_BookingSupplement_A_D
  as projection on YR_BookingSupplement_D
{
  key BookSupplUUID,
      ...
      /* Associations */
      _Booking : redirected to parent YC_Booking_A_D,
      _Product,
      _SupplementText,
      _Travel  : redirected to YC_TRAVEL_A_D
}
